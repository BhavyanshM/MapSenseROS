...
void FactorGraphSLAM::addPriorPoseFactor(Pose3 mean, Vector3 variance)
{
...
void FactorGraphSLAM::addOdometryFactor(Pose3 odometry, Vector3 odomVariance)
{
...
void FactorGraphSLAM::addOrientedPlaneLandmarkFactor(Vector4 lmMean, Vector3 lmVariance, int lmIndex)
{
   noiseModel::Diagonal::shared_ptr lmNoise = noiseModel::Diagonal::Sigmas(lmVariance);
