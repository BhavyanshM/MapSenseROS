...
{
   public:
      Eigen::Matrix4f CalculateAlignment(std::vector<float>& cloudOne, const Eigen::Matrix4f& transformOne, std::vector<float>& cloudTwo, const Eigen::Matrix4f& transformTwo, int *partIds = nullptr, int partCount = 32, int numVertBlocks = 8);
